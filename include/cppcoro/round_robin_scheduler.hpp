...
namespace cppcoro
{
	...
	private:
		...
		stde::coroutine_handle exchange_next(
			stde::coroutine_handle<> coroutine) noexcept
		{
		...
		size_t m_index;
		const stde::coroutine_handle<> m_noop;
		std::array<stde::coroutine_handle<>, N - 1> m_coroutines;
	};
#endif
}
